...
def create_match_1072317_fixture():
    ...
    both_innings_sample.write_parquet(test_dir / "match_1072317_both_innings_10_overs.parquet")
    ...
    match_info = {
        ...
        "wickets_innings_1": len([b for b in ball_data if b["innings_number"] == 1 and b["player_out_1"] != ""]),
        "wickets_innings_2": len([b for b in ball_data if b["innings_number"] == 2 and b["player_out_1"] != ""]),
    }
